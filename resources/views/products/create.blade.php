            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="precioventa" placeholder="Precio Venta">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="preciocompra" placeholder="Precio Compra">
                    </div>
                </div>
